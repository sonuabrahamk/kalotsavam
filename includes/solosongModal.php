<div class="modal fade" id="solosongModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-notice">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">clear</i></button>
                <strong><h3 class="modal-title" id="myModalLabel"><strong>Solo Song | Solo Event</strong></h3></strong>
            </div>
                ...
                <div class="instruction">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p> Only devotional Malayalam song is allowed. No instrument is allowed. 
                            </p>
                        </div>
                    </div>
                </div>
