        ...
        <div class="container">
            <div class="row" style="margin-top: 100px;">
                <div class="col-lg-12 col-md-12 text-center">
                    <img class="result-header" src="assets/img/kalotsavamlogo_line.png">
                </div>               
                                ...
                                <div class="tab-pane" id="group">
                                    <div class="row">
                                        <?php
                                            ...
                                            require ('dashboard/assets/snippets/connect.php');
                                            if($res = mysqli_query($connect,"SELECT * FROM `events` WHERE STATUS='PUBLISHED' AND CATEGORY='Group' ORDER BY `NAME`")){
                                                if(mysqli_num_rows($res) > 0){
