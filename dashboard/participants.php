                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php 
                                            ...
                                            $res3 = mysqli_query($connect,'SELECT DISTINCT(NAME) FROM events');
                            ...
                            <div class="col-md-3">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php 
                                            require('assets/snippets/connect.php');
                                            $res4 = mysqli_query($connect,'SELECT DISTINCT(CATEGORY) FROM events');
                            ...
                            <div class="col-md-3">
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <div class="form-group form-info  is-empty">
                                            <i class="material-icons">filter_list</i>
                                            <input type="text" class="form-control" placeholder="Status" id='statusTxt'>
                                        </div>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li class="statusOpt"><a href="#">PRESENT</a></li>
                                        <li class="statusOpt"><a href="#">ABSENT</a></li>
                                        <li class="statusOpt"><a href="#">DISQUALIFIED</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-3">
                                        ...
                                        <form name='scores' id='scoreVals'>
                                            ...
                                            <table class="table table-hover table-bordered partTable">
                                                <thead class="text-info">
                                                    <th style="min-width: 80px;">Cht No</th>
                                                    <th>NAME</th>
                                                    <th>PARISH</th>
                                                    <th>FORANE</th>
                                                    <th>SECTION</th>
