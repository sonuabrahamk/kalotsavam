                                ...
                                <div class="card">
                                    <div class="card-header" data-background-color="blue">
                                        ...
                                        <div class="col-lg-1 pull-right">
                                            <a id='exportToMobile' aria-expanded="false" style="cursor: pointer">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportToMobile').click(function() {
                ...
                window.location.href = 'assets/snippets/exports/exportResult_backup.php?cat='+cat+'&&event='+event+'&&pname='+pname+'&&chno='+chno+'&&forane='+forane+'&&parish='+parish;
