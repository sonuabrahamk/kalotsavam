                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php 
                                            ...
                                            $res = mysqli_query($connect,'SELECT DISTINCT(CATEGORY) FROM events WHERE STATUS="VERIFIED"');
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php 
                                            require('assets/snippets/connect.php');
                                            $res = mysqli_query($connect,'SELECT DISTINCT(NAME) FROM events WHERE STATUS="VERIFIED"');
                                            while($row = mysqli_fetch_array($res)){
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <div class="col-lg-3 col-md-3 col-xs-12 pull-right">
                                            <button type="submit" class="btn btn-info pull-right btn-block" id="uptScores">APPROVE Scores</button>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-xs-12 pull-right">
